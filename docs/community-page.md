...
- **Members**: Semua anggota aktif. Ditampilkan dalam bentuk grid dengan filter berdasarkan _Batch_ (angkatan).
...
- `Leaderboard`: Tabel dan Card (untuk mobile) yang menampilkan peringkat anggota berdasarkan perolehan poin. Poin dibagi menjadi _Attendance_, _Project_, dan _Event_.
...
Saat ini poin menggunakan _mock data_. Namun, ke depannya logika sistem perhitungan poin akan didapatkan dari:
